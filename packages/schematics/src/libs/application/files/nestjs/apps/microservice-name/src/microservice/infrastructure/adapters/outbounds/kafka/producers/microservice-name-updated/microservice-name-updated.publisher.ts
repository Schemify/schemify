...
import { MicroserviceNameDescriptionUpdatedPublisherPort } from '@microserviceName/microservice/application/ports/outbounds/messaging/microservice-name-description-updated-publisher.port'
