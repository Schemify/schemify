 ...
 * -----------------------------------------------------------------------------
 * Query de lectura que solicita una página de registros `__project_name_pascal__Entity`
 * usando paginación basada en cursor (afterId + limit).
 *
 * Es procesada por `Get__project_name_pascal__ByCursorHandler`, quien consulta el repositorio
 * correspondiente y devuelve la estructura de paginación.
 */
import { IQuery } from '@nestjs/cqrs'

export class Get__project_name_pascal__ByCursorQuery implements IQuery {
  constructor(
    /**
