...
import { Get__project_name_camel__WithCursorPrismaRepository } from './get__project_name_kebab__-with-cursor.prisma.repository'
...
describe('Get__project_name_camel__WithCursorPrismaRepository', () => {
  let repository: Get__project_name_camel__WithCursorPrismaRepository
  ...
  beforeEach(async () => {
    ...
    repository = module.get(Get__project_name_camel__WithCursorPrismaRepository)
