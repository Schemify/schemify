 ...
 * de escritura (`Commands`) para el agregado `__project_name_camel__`.
 *
...
import { Create__project_name_camel__GrpcController } from './create-__project_name_kebab__/create-__project_name_kebab__.grpc.controller'
import { Update__project_name_camel__GrpcController } from './update-__project_name_kebab__/update-__project_name_kebab__.grpc.controller'
import { Delete__project_name_camel__GrpcController } from './delete-__project_name_kebab__/delete-__project_name_kebab__.grpc.controller'
...
export const GrpcCommandControllers = [
  ...
  Delete__project_name_camel__GrpcController
]
