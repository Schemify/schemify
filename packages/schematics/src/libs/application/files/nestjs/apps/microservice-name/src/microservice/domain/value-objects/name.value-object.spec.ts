...
describe('NameValueObject', () => {
  describe('create', () => {
    it('should create name with valid value', () => {
      // Arrange & Act
      const name = NameValueObject.create('MicroserviceName Test')

      // Assert
      expect(name.value).toBe('MicroserviceName Test')
    })
  ...
  describe('equals', () => {
    it('should return true for same values', () => {
      // Arrange
      const name1 = NameValueObject.create('MicroserviceName Test')
      const name2 = NameValueObject.create('MicroserviceName Test')
    ...
    it('should return false for different values', () => {
      // Arrange
      const name1 = NameValueObject.create('MicroserviceName Test')
      const name2 = NameValueObject.create('MicroserviceName Diferente')
  ...
  describe('edge cases', () => {
    it('should handle special characters', () => {
      // Arrange & Act
      const name = NameValueObject.create('MicroserviceName @#$%^&*()')

      // Assert
      expect(name.value).toBe('MicroserviceName @#$%^&*()')
    })

    it('should handle numbers in name', () => {
      // Arrange & Act
      const name = NameValueObject.create('MicroserviceName 123')

      // Assert
      expect(name.value).toBe('MicroserviceName 123')
    })
