...
} from '@microserviceName/microservice/application/ports/outbounds/repositories/microservice-name-command-ports'

import {
  GetAllMicroserviceNamePort,
  GetMicroserviceNameByIdPort,
  GetMicroserviceNameWithCursorPort
} from '@microserviceName/microservice/application/ports/outbounds/repositories/microservice-name-query-ports'
