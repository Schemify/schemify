...
import { Create__project_name_camel__PrismaRepository } from './create__project_name_kebab__.prisma.repository'
...
describe('Create__project_name_camel__PrismaRepository', () => {
  let repository: Create__project_name_camel__PrismaRepository
  ...
  beforeEach(async () => {
    ...
    repository = module.get<Create__project_name_camel__PrismaRepository>(
      Create__project_name_camel__PrismaRepository
    )
    createSpy = mockPrismaService.__project_name_camel__.create
  ...
  describe('create', () => {
    it('should create __project_name_camel__ successfully', async () => {
      ...
      const mockMappedEntity = __project_name_camel__Entity.create({
        name: 'Test __project_name_camel__',
        description: 'Test Description'
      })
    ...
    it('should return mapped entity from mapper', async () => {
      ...
      const expectedMappedEntity = __project_name_camel__Entity.create({
        name: 'Mapped __project_name_camel__',
