import { __project_name_pascal__Mapper } from './__project_name_camel__.mapper'
...
describe('__project_name_pascal__Mapper', () => {
  ...
  describe('protoToProps', () => {
    it('should transform proto to props with name and description', () => {
      ...
      // Assert
      expect(result.name.value).toBe('Test __project_name_camel__')
  ...
  describe('fromPrimitives', () => {
    it('should reconstruct entity from primitives successfully', () => {
      ...
      expect(result.props.name.value).toBe('Test __project_name_camel__')
  ...
  describe('fromEnvelope', () => {
    it('should transform __project_name_camel__CreatedEvent to Create__project_name_camel__Dto', () => {
      // Arrange
      const entity = __project_name_camel__Entity.create({
        name: 'Test __project_name_camel__',
        description: 'Test Description'
    ...
    it('should transform __project_name_camel__CreatedEvent without description', () => {
      // Arrange
      const entity = __project_name_camel__Entity.create({
        name: 'Test __project_name_camel__'
        // No description
