...
import { GetAllMicroserviceNameGrpcController } from './get-all-microservice-name/get-all-microservice-name.grpc.controller'
import { GetMicroserviceNameByIdGrpcController } from './get-microservice-name-by-id/get-microservice-name-by-id.grpc.controller'
import { GetMicroserviceNameByCursorGrpcController } from './get-microservice-name-by-cursor/get-microservice-name-by-cursor.grpc.controller'
...
export * from './get-all-microservice-name/get-all-microservice-name.grpc.controller'
export * from './get-microservice-name-by-id/get-microservice-name-by-id.grpc.controller'
export * from './get-microservice-name-by-cursor/get-microservice-name-by-cursor.grpc.controller'
