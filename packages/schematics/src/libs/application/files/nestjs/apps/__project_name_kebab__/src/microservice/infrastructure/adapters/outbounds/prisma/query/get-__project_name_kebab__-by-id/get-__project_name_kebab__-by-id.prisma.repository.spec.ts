...
import { Get__project_name_camel__ByIdPrismaRepository } from './get__project_name_kebab__-by-id.prisma.repository'
...
describe('Get__project_name_camel__ByIdPrismaRepository', () => {
  let repository: Get__project_name_camel__ByIdPrismaRepository
  ...
  beforeEach(async () => {
    ...
    repository = module.get(Get__project_name_camel__ByIdPrismaRepository)
