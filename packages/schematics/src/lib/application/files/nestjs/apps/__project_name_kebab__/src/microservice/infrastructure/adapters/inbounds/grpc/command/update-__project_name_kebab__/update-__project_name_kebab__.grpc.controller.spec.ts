...
import { Update__project_name_pascal__GrpcController } from './update-__project_name_camel__.grpc.controller'
...
describe('Update__project_name_pascal__GrpcController', () => {
  ...
  describe('update__project_name_pascal__', () => {
    it('should update __project_name_camel__ successfully with all fields', async () => {
      // Arrange
      const request: __project_name_camel__.Update__project_name_pascal__Dto = {
        id: 'test-id-123',
        __project_name_camel__: {
          name: '__project_name_pascal__ Actualizado',
          description: 'Nueva descripción del __project_name_camel__'
        }
      }

      const mockProps = {
        name: NameValueObject.create('__project_name_pascal__ Actualizado'),
    ...
    it('should throw error when __project_name_camel__ object is missing', async () => {
      ...
      } as __project_name_camel__.Update__project_name_pascal__Dto

      // Act & Assert
      await expect(
        controller.update__project_name_pascal__(request)
    ...
    it('should handle command bus errors', async () => {
      ...
      const mockProps = {
        name: NameValueObject.create('__project_name_pascal__ Error'),
    ...
    it('should handle mapper errors during entityToProto', async () => {
      ...
      const mockProps = {
        name: NameValueObject.create('__project_name_pascal__ Mapper Error'),
        description: DescriptionValueObject.create('Descripción')
      }
  ...
  describe('constructor and dependencies', () => {
    ...
    it('should have correct method signature', () => {
      ...
      expect(controller.update__project_name_pascal__.name).toBe(
