...
import { __project_name_pascal__CreatedEventHandler } from './__project_name_camel__-created.event-handler'
...
describe('__project_name_pascal__CreatedEventHandler', () => {
  ...
  describe('handle', () => {
    it('should handle __project_name_pascal__CreatedEvent successfully', async () => {
      // Arrange
      const __project_name_camel__Entity = __project_name_pascal__Entity.create(
        {
          name: '__project_name_pascal__ Test',
          description: 'Descripción del __project_name_camel__'
        }
      )
      const event = new __project_name_pascal__CreatedEvent(
    ...
    it('should handle multiple events in sequence', async () => {
      // Arrange
      const __project_name_camel__1 = __project_name_pascal__Entity.create({
        name: '__project_name_pascal__ 1'
      })
      const __project_name_camel__2 = __project_name_pascal__Entity.create({
        name: '__project_name_pascal__ 2'
      })
      const event1 = new __project_name_pascal__CreatedEvent(
        __project_name_camel__1
      )
      const event2 = new __project_name_pascal__CreatedEvent(
    ...
    it('should preserve event properties correctly', async () => {
      ...
      const __project_name_camel__Entity = __project_name_pascal__Entity.create(
        {
          name: '__project_name_pascal__ Verificación',
      ...
      expect(event.__project_name_camel__.props.name.value).toBe(
        '__project_name_pascal__ Verificación'
      )
