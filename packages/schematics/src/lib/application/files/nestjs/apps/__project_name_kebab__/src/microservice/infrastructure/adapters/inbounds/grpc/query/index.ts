 ...
 * de lectura (`Query`) para el agregado `__project_name_pascal__`.
 *
 ...
 *
 * ❗ Importante:
 * - No se debe usar `implements __project_name_pascal__ServiceController` ya que estos controladores
 *   sólo implementan parcialmente los métodos gRPC.
 * - NestJS los enlaza mediante el decorador `@__project_name_pascal__ServiceControllerMethods()`.
 *
 * Uso típico:
 *
 * ```ts
...
import { GetAll__project_name_pascal__GrpcController } from './get-all-__project_name_kebab__/get-all-__project_name_camel__.grpc.controller'
...
export * from './get-all-__project_name_kebab__/get-all-__project_name_camel__.grpc.controller'
