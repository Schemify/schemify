 ...
 * ✅ Convertir la entidad `__project_name_pascal__Entity` en una respuesta Protobuf (__project_name_camel__.__project_name_pascal__)
 * ✅ Devolver la respuesta al __project_name_camel__ gRPC
 *
...
export class Get__project_name_pascal__ByIdGrpcController {
   ...
   *  4. Se transforma en un objeto Protobuf (`__project_name_camel__.__project_name_pascal__`)
   *  5. Se retorna al __project_name_camel__ gRPC
   *
   * @param request DTO generado desde el contrato gRPC (`.proto`)
   * @returns __project_name_camel__.__project_name_pascal__ (objeto compatible con el contrato Protobuf)
   */
