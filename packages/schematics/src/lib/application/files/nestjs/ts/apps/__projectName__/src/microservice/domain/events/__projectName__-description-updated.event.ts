/**
 * __ProjectName__DescriptionUpdatedEvent
 * -----------------------------------------------------------------------------
 * Evento de dominio que indica que la descripción de un `__ProjectName__Entity` fue modificada.
 *
...
export class __ProjectName__DescriptionUpdatedEvent implements IEvent {
  constructor(
