...
import { GetAll__project_name_pascal__GrpcController } from './get-all-__project_name_kebab__.grpc.controller'
import { GetAll__project_name_pascal__Query } from '@__project_name_kebab__/microservice/application/ports/inbounds/queries'
...
describe('GetAll__project_name_pascal__GrpcController', () => {
  ...
  describe('getAll__project_name_pascal__', () => {
    it('should return all __project_name_kebab__ successfully', async () => {
      // Arrange
      const mockEntities = [
      ...
      expect(result.__project_name_kebab__).toHaveLength(3)
    })
    ...
    it('should handle single cliente with all fields', async () => {
      // Arrange
    ...
    it('should handle single cliente without description', async () => {
      // Arrange
      const mockEntity = __project_name_pascal__Entity.create({
      ...
      expect(result).toEqual(expectedResponse)
      expect(result.__project_name_kebab__[0].description).toBeUndefined()
    })

    it('should handle large number of __project_name_kebab__', async () => {
      // Arrange
    ...
    it('should return all clientes when query succeeds', async () => {
      const expectedEntities = [
        __project_name_pascal__Entity.create({ name: 'Cliente 1' }),
        __project_name_pascal__Entity.create({ name: 'Cliente 2' })
      ]

      queryBus.execute.mockResolvedValue(expectedEntities)

      const result = await controller.getAllClientes()
  ...
  describe('constructor and dependencies', () => {
    it('should be properly instantiated with dependencies', () => {
      ...
      expect(controller).toBeInstanceOf(GetAll__project_name_pascal__GrpcController)
    ...
    it('should have correct method signature', () => {
      ...
      expect(controller.getAll__project_name_pascal__.name).toBe('getAll__project_name_pascal__')
    })
  })
})
