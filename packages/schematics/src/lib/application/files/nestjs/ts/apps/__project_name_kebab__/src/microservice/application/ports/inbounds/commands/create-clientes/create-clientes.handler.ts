 ...
 *
 * Flujo de ejecución:
 * 1. El cliente o servicio envía `Create__project_name_pascal__Command` al `CommandBus`
  ...
  implements ICommandHandler<Create__project_name_pascal__Command>
{
   ...
   */
  async execute(command: Create__project_name_pascal__Command): Promise<__project_name_pascal__Entity> {
