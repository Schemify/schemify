...
import { Kafka__project_name_pascal__CreatedPublisher } from './__project_name_camel__-created.adapter'
  ...
  describe('publish', () => {
      ...
      expect(messageValue).toMatchObject({
        ...
        payload: {
          __project_name_camel__: {
            ...
            props: {
              name: { value: 'Test __project_name_pascal__' },
    ...
    it('should handle __project_name_camel__ without description', async () => {
      ...
      expect(emitSpy).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          key: __project_name_camel__.id,
          value: expect.stringContaining('Test __project_name_pascal__')
        })
      )
    })
  })
