...
import { Create__project_name_pascal__Handler } from './create-__project_name_kebab__.handler'
import { Create__project_name_pascal__Command } from './create-__project_name_kebab__.command'
import { Create__project_name_pascal__Port } from '@__project_name_kebab__/microservice/application/ports/outbounds/repositories/__project_name_kebab__-command-ports'
...
describe('Create__project_name_pascal__Handler', () => {
  ...
  beforeEach(async () => {
    ...
    create__project_name_pascal__Port = module.get(Create__project_name_pascal__Port)
  ...
  describe('execute', () => {
    ...
    it('should throw error when invalid data is provided', async () => {
      // Arrange
      const invalidCommand = new Create__project_name_pascal__Command('', 'desc')
    ...
    it('should propagate repository errors', async () => {
      // Arrange
      const command = new Create__project_name_pascal__Command('Cliente OK', 'desc')
      const repositoryError = new Error('Database connection failed')
      create__project_name_pascal__Port.create.mockRejectedValue(repositoryError)
    ...
    it('should create client without description when not provided', async () => {
      // Arrange
      const command = new Create__project_name_pascal__Command('Cliente Sin Descripción')
      const mockEntity = __project_name_pascal__Entity.create({
