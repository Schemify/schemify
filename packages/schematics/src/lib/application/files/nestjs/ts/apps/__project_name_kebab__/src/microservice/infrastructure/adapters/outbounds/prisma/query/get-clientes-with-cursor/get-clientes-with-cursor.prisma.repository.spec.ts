...
import { Get__project_name_pascal__WithCursorPrismaRepository } from './get-__project_name_kebab__-with-cursor.prisma.repository'
...
describe('Get__project_name_pascal__WithCursorPrismaRepository', () => {
  ...
  beforeEach(async () => {
    ...
    repository = module.get(Get__project_name_pascal__WithCursorPrismaRepository)
  ...
  it('should get __project_name_kebab__ with cursor successfully', async () => {
    // Arrange
    const mockResults = [
      {
        id: '1',
  ...
  it('should return empty result when no __project_name_kebab__ exist', async () => {
    // Arrange
