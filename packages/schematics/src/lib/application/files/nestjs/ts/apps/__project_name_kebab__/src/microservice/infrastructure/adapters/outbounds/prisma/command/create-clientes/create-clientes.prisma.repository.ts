...
@Injectable()
export class Create__project_name_pascal__PrismaRepository implements Create__project_name_pascal__Port {
  constructor(
    private readonly prisma: PrismaService,
    private readonly mapper: __project_name_pascal__Mapper
  ) {}

  async create(entity: __project_name_pascal__Entity): Promise<__project_name_pascal__Entity> {
