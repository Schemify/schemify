 ...
 * ✅ Convertir la entidad resultante en un objeto `__project_name_kebab__.__project_name_pascal__` (Protobuf)
 *
...
export class Update__project_name_pascal__GrpcController {
   ...
   * @returns __project_name_kebab__.__project_name_pascal__` (respuesta actualizada)
   */

  @GrpcMethod('ClientesService', 'updateClientes')
  async updateClientes(
    request: __project_name_kebab__.Update__project_name_pascal__Dto
