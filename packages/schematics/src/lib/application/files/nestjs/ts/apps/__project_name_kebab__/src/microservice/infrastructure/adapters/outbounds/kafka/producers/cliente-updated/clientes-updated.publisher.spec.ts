...
import { Kafka__project_name_pascal__DescriptionUpdatedPublisher } from './__project_name_kebab__-updated.publisher'
...
describe('Kafka__project_name_pascal__DescriptionUpdatedPublisher', () => {
  ...
  beforeEach(async () => {
    ...
    publisher = module.get<Kafka__project_name_pascal__DescriptionUpdatedPublisher>(
      Kafka__project_name_pascal__DescriptionUpdatedPublisher
    )
  ...
  describe('publish', () => {
    it('should publish __project_name_kebab__ description updated event successfully', async () => {
      // Arrange
      ...
      expect(emitSpy).toHaveBeenCalledWith('__project_name_kebab__.description-updated', {
        key: 'test-id',
