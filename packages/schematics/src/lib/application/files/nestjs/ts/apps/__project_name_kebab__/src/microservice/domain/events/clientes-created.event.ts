...
import { __project_name_pascal__Entity } from '../entities/__project_name_kebab__.entity'
import { DomainEvent } from '../domain/domain.event'

export class __project_name_pascal__CreatedEvent extends DomainEvent implements IEvent {
