...
import { Get__project_name_pascal__ByIdPrismaRepository } from './get-__project_name_kebab__-by-id.prisma.repository'
...
describe('Get__project_name_pascal__ByIdPrismaRepository', () => {
  ...
  beforeEach(async () => {
    ...
    findUniqueSpy = mockPrismaService.__project_name_kebab__.findUnique
  ...
  it('should get __project_name_kebab__ by id successfully', async () => {
    // Arrange
    const mockResult = {
      id: 'test-id',
      name: 'Test Cliente',
  ...
  it('should return null when __project_name_kebab__ not found', async () => {
    // Arrange
