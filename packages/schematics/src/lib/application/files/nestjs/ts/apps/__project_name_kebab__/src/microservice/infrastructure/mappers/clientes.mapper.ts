...
} from '@__project_name_kebab__/microservice/domain/entities/__project_name_kebab__.entity'
...
export class __project_name_pascal__Mapper {
   ...
   */
  toPrimitives(entity: __project_name_pascal__Entity): __project_name_pascal__Primitives {
   ...
   */
  fromPrimitives(input: __project_name_pascal__Primitives): __project_name_pascal__Entity {
