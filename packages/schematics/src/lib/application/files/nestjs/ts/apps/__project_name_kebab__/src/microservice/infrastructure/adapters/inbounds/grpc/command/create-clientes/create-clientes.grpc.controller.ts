...
export class Create__project_name_pascal__GrpcController {
   ...
   * @returns `__project_name_kebab__.__project_name_pascal__` (respuesta serializada)
   */
  @GrpcMethod('ClientesService', 'createClientes')
  async createClientes(
    request: __project_name_kebab__.Create__project_name_pascal__Dto
  ): Promise<__project_name_kebab__.__project_name_pascal__> {
    const command = new Create__project_name_pascal__Command(request.name, request.description)
