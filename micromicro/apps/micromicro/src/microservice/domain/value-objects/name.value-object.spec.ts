...
describe('NameValueObject', () => {
  describe('create', () => {
    it('should create name with valid value', () => {
      // Arrange & Act
      const name = NameValueObject.create('Micromicro Test')

      // Assert
      expect(name.value).toBe('Micromicro Test')
    })

    it('should trim whitespace from name', () => {
      // Arrange & Act
      const name = NameValueObject.create(
        '  Micromicro con espacios  '
      )

      // Assert
      expect(name.value).toBe('Micromicro con espacios')
    })
  ...
  describe('equals', () => {
    it('should return true for same values', () => {
      // Arrange
      const name1 = NameValueObject.create('Micromicro Test')
      const name2 = NameValueObject.create('Micromicro Test')
    ...
    it('should return false for different values', () => {
      // Arrange
      const name1 = NameValueObject.create('Micromicro Test')
      const name2 = NameValueObject.create('Micromicro Diferente')
  ...
  describe('edge cases', () => {
    it('should handle special characters', () => {
      // Arrange & Act
      const name = NameValueObject.create('Micromicro @#$%^&*()')

      // Assert
      expect(name.value).toBe('Micromicro @#$%^&*()')
    })

    it('should handle numbers in name', () => {
      // Arrange & Act
      const name = NameValueObject.create('Micromicro 123')

      // Assert
      expect(name.value).toBe('Micromicro 123')
    })

    it('should handle unicode characters', () => {
      // Arrange & Act
      const name = NameValueObject.create(
        'Micromicro Español ñáéíóú'
      )

      // Assert
      expect(name.value).toBe('Micromicro Español ñáéíóú')
    })
  })
})
