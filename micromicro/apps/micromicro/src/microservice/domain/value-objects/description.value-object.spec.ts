...
describe('DescriptionValueObject', () => {
  describe('create', () => {
    it('should create description with valid value', () => {
      ...
      // Assert
      expect(description.value).toBe('Descripción del micromicro')
    })
    ...
    it('should handle very long description', () => {
      ...
      const longDescription =
        'Esta es una descripción muy larga que contiene muchos caracteres para probar el comportamiento del value object cuando se manejan textos extensos que podrían ser utilizados para describir micromicro con información detallada sobre sus características, necesidades y preferencias.'
  ...
  describe('edge cases', () => {
    ...
    it('should handle numbers in description', () => {
      // Arrange & Act
      const description = DescriptionValueObject.create(
        'Micromicro número 123'
      )

      // Assert
      expect(description.value).toBe('Micromicro número 123')
    })
