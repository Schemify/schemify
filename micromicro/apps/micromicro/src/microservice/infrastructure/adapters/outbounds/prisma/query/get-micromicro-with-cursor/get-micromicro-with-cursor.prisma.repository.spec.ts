...
import { GetMicromicroWithCursorPrismaRepository } from './get-micromicro-with-cursor.prisma.repository'
...
describe('GetMicromicroWithCursorPrismaRepository', () => {
  let repository: GetMicromicroWithCursorPrismaRepository
  ...
  it('should get micromicro with cursor successfully', async () => {
    // Arrange
    const mockResults = [
      {
        id: '1',
  ...
  it('should return empty result when no micromicro exist', async () => {
    // Arrange
