import { MicromicroMapper } from './micromicro.mapper'
...
describe('MicromicroMapper', () => {
  let mapper: MicromicroMapper

  beforeEach(() => {
    mapper = new MicromicroMapper()
  })
  ...
  describe('protoToProps', () => {
    it('should transform proto to props with name and description', () => {
      ...
      // Assert
      expect(result.name.value).toBe('Test Micromicro')
  ...
  describe('fromPrimitives', () => {
    it('should reconstruct entity from primitives successfully', () => {
      ...
      expect(result.props.name.value).toBe('Test Micromicro')
  ...
  describe('fromEnvelope', () => {
    it('should transform MicromicroCreatedEvent to CreateMicromicroDto', () => {
      // Arrange
      const entity = MicromicroEntity.create({
        name: 'Test Micromicro',
        description: 'Test Description'
    ...
    it('should transform MicromicroCreatedEvent without description', () => {
      // Arrange
      const entity = MicromicroEntity.create({
        name: 'Test Micromicro'
        // No description
