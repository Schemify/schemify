...
# Script de entrypoint inteligente para el microservicio de micromicro
# Detecta el estado de la base de datos y sincroniza migraciones automáticamente

echo "🚀 Iniciando microservicio de micromicro..."
...
# Función para generar el micromicro Prisma
generate_prisma_client() {
    echo "🔧 Generando micromicro Prisma..."
    npx prisma generate
    echo "✅ Micromicro Prisma generado"
}
...
exec node ./dist/apps/micromicro/src/main 